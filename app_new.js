...
Responda como psicólogo de forma concisa:`
  ...
  addMessage({ text, sender, timestamp, isError = false }) {
    ...
    // Add breathing space after bot messages about anxiety techniques
    if (sender === 'bot' && this.containsBreathingTechnique(text)) {
      this.addBreathingExercise()
    }
  }
  ...
  containsBreathingTechnique(text) {
    ...
    return breathingKeywords.some((keyword) =>
  ...
  addBreathingExercise() {
    setTimeout(() => {
      ...
      exerciseElement.className = 'breathing-exercise'
      exerciseElement.innerHTML = `
                <div class="exercise-card">
                    <h4><i class="fas fa-wind"></i> Exercício Rápido de Respiração</h4>
                    <div class="breathing-guide">
                        <div class="breath-circle" id="breath-circle">
                            <span class="breath-text" id="breath-text">Clique para começar</span>
                        </div>
                        <button class="start-exercise" onclick="startBreathingExercise()">
      ...
      this.chatMessages.appendChild(exerciseElement)
      this.scrollToBottom()
    }, 1000)
  }
